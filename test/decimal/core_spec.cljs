...
(t/deftest api-test
  (doseq [v +test-values+]
    ...
    ;; (equal-or-both-NaN (dc/max v 2) (.max dc/+decimal+ v 2))
    ;; (equal-or-both-NaN (dc/min v 2) (.min dc/*decimal* v 2))
    ...
    ;; (equal-or-both-NaN (dc/hypot v 2) (.hypot dc/+decimal+ v 2))
    ...
    ;; (equal-or-both-NaN (dc/to-fraction v 1) (.toFraction (dc/-decimal v) 1))
    (equal-or-both-NaN (dc/to-power v 2) (.toPower (dc/-decimal v) 2))
